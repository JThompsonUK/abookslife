            ...
            <div class="p-5 mb-4 bg-light rounded-3">
                <div class="container-fluid row">
                    ...
                    <div class="col-md-8">
                        ...
                        <p v-if="book.book_genre">Genre: {{ book.book_genre }}</p>
                        ...
                        <div v-if="!loggedIn" class="text-danger">
                        ...
                        <div v-else class="text-danger">
                            <div v-if="this.isCheckedOut">
                                <div v-if="this.isWithUser">
                                    ...
                                    <button class="btn btn-primary" type="submit" @click="returnbook">Return book</button>
                                </div>
                                <div v-else>
                                    This is still checked out by another user, however, you can still checkout the book
                                    <button @click="checkoutModal" class="btn btn-primary">Checkout book</button>
                                </div>
                            </div>
                            <div v-else>
                    ...
                    <div v-if="isOwner || isWithUser" class="col-md-2 text-right">
                        <a v-if="isOwner" :href="route('book.edit', book.uuid)">
                        ...
                        <button @click="infoModal" class="btn btn-primary"> ? </button>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            modalDescription: '<div>QR Code: Print this off and stick it in your book, so people can easily access this page.</div><div>Reference: If you aren&#39;t able to print the QR code, simply write this reference in your book so other users can find this page.</div>',
        };
    },
