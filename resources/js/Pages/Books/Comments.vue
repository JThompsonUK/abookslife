<template>
    <div>
        <div v-if="loggedIn" class="card shadow-sm rounded-0 p-3 mt-3">
...
export default {
    ...
    methods: {
        store() {
            this.form.post(this.route('book.comment', this.bookUuid))
        },
        ...
        saveComment(comment) {
            this.form.put(this.route('book.comment.update', { book: this.bookUuid, bookComments: comment.id }), {
        ...
        deleteComment(comment) {
            this.form.post(this.route('book.comment.delete', { book: this.bookUuid, bookComments: comment.id }));
        },
    },
}
</script>
