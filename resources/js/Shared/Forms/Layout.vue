    ...
    <div class="md:flex md:flex-col">
      <div class="md:h-screen md:flex md:flex-col">
        <div class="md:flex md:flex-shrink-0">
          <div class="md:flex-shrink-0 md:w-56 px-6 py-4 flex items-center justify-between md:justify-center" style="background-color: #7092ab">
            <inertia-link class="mt-1" href="/">
<!--              <logo class="fill-white" width="120" height="28" />-->
                <div>A Books Life</div>
            </inertia-link>
          ...
          <div class="w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center" style="background-color: #7092ab">
            <div class="mt-1 mr-4">{{ $page.props.auth.user.account.name }}</div>
              <inertia-link class="flex items-center group py-3" :href="route('bookshelf')">
              <icon name="printer" class="w-4 h-4 mr-2" :class="'fill-white'" />
              <div :class="'text-white'">My Bookshelf</div>
              </inertia-link>
              <inertia-link class="flex items-center group py-3" :href="route('books')">
              <icon name="printer" class="w-4 h-4 mr-2" :class="'fill-white'" />
              <div :class="'text-white'">Search Books</div>
              </inertia-link>
