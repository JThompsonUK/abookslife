  ...
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('bookshelf')">
        <icon name="printer" class="w-4 h-4 mr-2" :class="isUrl('bookshelf') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('bookshelf') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">My Bookshelf</div>
      </inertia-link>
    </div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('books')">
        <icon name="printer" class="w-4 h-4 mr-2" :class="isUrl('books') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('books') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Search Books</div>
      </inertia-link>
    </div>
  </div>
</template>
